...
class AppColors{
  static final Color himalayaBlue = const Color(0xFF13ab9f);
  static final Color himalayaGrey = const Color(0xFF696969);
  static final Color himalayaWhite = const Color(0xFFffffff);
  static final Color paraColor = const Color(0xFF8f837f);
  static final Color iconColor1 = const Color(0xFFffd38d);
